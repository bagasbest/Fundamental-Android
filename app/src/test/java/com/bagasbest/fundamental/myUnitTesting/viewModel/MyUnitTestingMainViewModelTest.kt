...
class MyUnitTestingMainViewModelTest {

    private lateinit var mainViewModel: MyUnitTestingMainViewModel
    private lateinit var cuboidModel: MyUnitTestingCuboidModel
    ...
    @Before
    fun before() {
        cuboidModel = mock(MyUnitTestingCuboidModel::class.java)
        mainViewModel = MyUnitTestingMainViewModel(cuboidModel)
    }

    @Test
    fun getCircumference() {
        cuboidModel = MyUnitTestingCuboidModel()
        mainViewModel = MyUnitTestingMainViewModel(cuboidModel)
